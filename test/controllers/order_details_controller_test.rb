...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference("OrderDetail.count") do
      post order_details_url, params: { order_detail: { count: @order_detail.count, medicine_id: @order_detail.medicine_id, order_id: @order_detail.order_id } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { count: @order_detail.count, medicine_id: @order_detail.medicine_id, order_id: @order_detail.order_id } }
